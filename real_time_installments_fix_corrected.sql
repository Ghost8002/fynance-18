-- SOLUÇÃO EM TEMPO REAL PARA PARCELAMENTOS - CORRIGIDA
...
-- =====================================================
-- 2. REMOVER FUNÇÕES EXISTENTES ANTES DE RECRIAR
-- =====================================================

-- Remover funções existentes
DROP FUNCTION IF EXISTS create_debts_from_installments(UUID);
DROP FUNCTION IF EXISTS auto_create_debts_from_installment();
DROP FUNCTION IF EXISTS update_debt_when_installment_paid();
DROP FUNCTION IF EXISTS sync_existing_installments();

-- =====================================================
-- 3. CRIAR FUNÇÃO PARA SINCRONIZAÇÃO EM TEMPO REAL
-- =====================================================
...
-- =====================================================
-- 5. CRIAR TRIGGER PARA ATUALIZAR DÍVIDAS QUANDO PARCELAS SÃO PAGAS
-- =====================================================
...
-- =====================================================
-- 6. CRIAR FUNÇÃO sync_card_debts CORRIGIDA
-- =====================================================
...
-- =====================================================
-- 7. CRIAR FUNÇÃO PARA SINCRONIZAR PARCELAMENTOS EXISTENTES
-- =====================================================
...
-- =====================================================
-- 8. VERIFICAR E CRIAR POLÍTICAS RLS
-- =====================================================
...
-- =====================================================
-- 9. SINCRONIZAR PARCELAMENTOS EXISTENTES
-- =====================================================
...
-- =====================================================
-- 11. VERIFICAR SE OS TRIGGERS FORAM CRIADOS
-- =====================================================
...
WHERE trigger_name IN ('trigger_auto_create_debts', 'trigger_update_debt_on_payment')
