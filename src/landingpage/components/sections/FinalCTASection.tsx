...
const guarantees = ["Cancele quando quiser", "Suporte humanizado"];
export const FinalCTASection = () => {
  return <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-primary/5 via-background to-primary/10 relative overflow-hidden">
      ...
      <div className="container px-4 relative z-10">
        ...
        once: true
          ...
          once: true
            ...
            {guarantees.map((guarantee, index) => <span key={index} className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-muted-foreground">
