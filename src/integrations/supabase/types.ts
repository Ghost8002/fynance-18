  ...
  public: {
    Tables: {
      ...
      debt_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "debt_tags_debt_id_fkey"
            columns: ["debt_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "debt_tags_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
      ...
      receivable_payment_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "receivable_payment_tags_receivable_payment_id_fkey"
          ...
          {
            foreignKeyName: "receivable_payment_tags_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
            referencedRelation: "tags"
            referencedColumns: ["id"]
      ...
      receivable_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "receivable_payments_subcategory_id_fkey"
            columns: ["subcategory_id"]
            isOneToOne: false
            referencedRelation: "subcategories"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      create_next_recurring_debt: { Args: { debt_id: string }; Returns: string }
      ...
      sync_card_debts: { Args: never; Returns: Json }
      sync_debt_payment:
        | {
            Args: {
              p_debt_id: string
      ...
      sync_existing_installments: { Args: never; Returns: Json }
