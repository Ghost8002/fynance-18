                    ...
                    return (
                      <SidebarMenuItem key={item.href}>
                        <SidebarMenuButton 
                          ...
                          className="w-full h-11 px-4 rounded-xl transition-all duration-300 group
                                     ...
                                     data-[active=true]:text-primary-foreground data-[active=true]:shadow-lg data-[active=true]:font-semibold" 
                          style={{
